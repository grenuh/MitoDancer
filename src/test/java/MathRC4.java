...
class MathRC4 {
    ...
    static Object[] calculate(String ent, boolean additionalDiagrams, boolean preCalibr, boolean ignored, boolean export, Object[] fileData) {
        ...
        for (int i = 0; i < arr.length; i++) {
            switch (arr[i]) {
                ...
                case "4":
                    ...
                    java.util.List<CentroidCluster<DoublePoint>> clusters = ghhh.cluster(Arrays.asList(points));
                ...
                case "7":
                    ...
                    java.util.List<CentroidCluster<DoublePoint>> clusters7 = ghhh7.cluster(Arrays.asList(points7));
        ...
        XYChart chart = new XYChart(600, 600);
        XYSeries series = chart.addSeries(res.getString("RawData"), time, data);
